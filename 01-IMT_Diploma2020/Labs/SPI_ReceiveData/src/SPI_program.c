...
u16 SPI1_voidSendReceiveSynch(u16 Copy_u16DataToTransmit)
{
	DIO_voidSetValue(SPI1_SLAVE_PIN , GPIO_LOW);
	...
	DIO_voidSetValue(SPI1_SLAVE_PIN , GPIO_HIGH);
...
{   
	...
	/* Receive Data */
	u16 Local_u16ReceData = ((SPI -> SPI_DR));
	/* call function */
